...
# angle : R => 50 : 132 -40 : 132 -45 : 112
    ...
    def checkParkingLot(self):
        ...
        if self.mode == 0:
            print('mode 0 : line tracing', ' right : ', self.right ,   'rback_prev : ' , self.rback_prev, 'rback : ', self.rback)
        ...
        if self.mode == 1: # check for mode 2 
            print('mode 1 : line tracing, ', 'right_prev : ' , self.right_prev, ' right : ' ,self.right)
        ...
        if self.mode == 2: # start parking mode
            ...
            print("rback val : ", self.rback, "back val : ", self.back, "left val : ",self.lback)
